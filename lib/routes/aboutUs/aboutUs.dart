        ...
        body: Container(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.all(15),
              child: Text(
                  'PSchool provides 1000s of learning, practice and fun activities for kids. Our goal is to provide affordable education technology for everyone.',
                  style: paraStyle),
            ),
            Padding(
                padding: EdgeInsets.all(15),
                child: Text(
                    'P in PSchool stands for Practice. Practice makes the learning perfect and permanent.',
                    style: paraStyle)),
            Padding(
                padding: EdgeInsets.all(15),
                child: RichText(
