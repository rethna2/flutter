    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 15),
            Text(
                'By becoming a member you get access to all locked activities.',
                style: textStyle),
            SizedBox(height: 15),
            Text('We also provide access to 100s of printable worksheets.',
                style: textStyle),
            SizedBox(height: 15),
            Text(
                'We keep lot of our activities free so that It can benefit many students. Kindly support us by becoming a member. It helps us to pay our employees, bills and to build a better app in the coming years.',
                style: textStyle)
          ],
        ));
  }
